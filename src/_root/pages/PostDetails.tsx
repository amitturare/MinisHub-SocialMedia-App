...
import { useDeletePostMutation, useGetPostByIdMutation } from "@/lib/react-query/queriesAndMutations";
                    ...
                    <div className="flex-between w-full">
                        ...
                        <div className="flex-center gap-8">
                            ...
                            <Button
                                ...
                                variant="ghost"
                                className={`ghost_details-delete_btn ${user.id !== post?.creator.$id && 'hidden'} px-0 py-0`}
                            >
